...
func (x *GatewayInformation) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *GatewayInformation) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *AirtimeReceipt) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
var file_router_router_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x6a, 0x6f, 0x69, 0x6e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x58, 0x0a, 0x12,
